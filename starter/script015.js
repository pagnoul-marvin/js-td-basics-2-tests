...
const fistName = prompt('Entrez votre prénom');
const yourAge = prompt('Entrez votre âge');

if (yourAge < 13) {
    console.log(`${fistName} est un petit garçon`);
}
else if ((yourAge >= 13) && (yourAge < 20)) {
    console.log(`${fistName} est un adolescent`);
}
else if ((yourAge >= 20) && (yourAge < 30)) {
    console.log(`${fistName} est un jeune homme`);
}
else {
    console.log(`${fistName} est un homme`);
}
